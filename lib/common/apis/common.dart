...
import 'package:flutter_note/common/entities/common_result.dart';
import 'package:flutter_note/common/entities/detail/calllog.dart';
import 'package:flutter_note/common/entities/detail/claim_customer.dart';
import 'package:flutter_note/common/entities/detail/connect.dart';
import 'package:flutter_note/common/entities/detail/free_vip.dart';
import 'package:flutter_note/common/entities/detail/store_vip.dart';
import 'package:flutter_note/common/entities/detail/user.dart';
import 'package:flutter_note/common/entities/detail/user_detail.dart';
import 'package:flutter_note/common/entities/detail/viewcall.dart';
import 'package:flutter_note/common/entities/flow/wx_article.dart';
import 'package:flutter_note/common/entities/home/erp_user.dart';
import 'package:flutter_note/common/entities/home/tree_store.dart';
import 'package:flutter_note/common/entities/im/group.dart';
import 'package:flutter_note/common/entities/loan/channel.dart';
import 'package:flutter_note/common/entities/loan/ckt_file.dart';
import 'package:flutter_note/common/entities/loan/lending.dart';
import 'package:flutter_note/common/entities/loan/loan_detail.dart';
import 'package:flutter_note/common/entities/loan/quota_list.dart';
import 'package:flutter_note/common/entities/loan/saleman.dart';
import 'package:flutter_note/common/entities/loan/saleman_detail.dart';
import 'package:flutter_note/common/entities/loan/saleman_grid.dart';
import 'package:flutter_note/common/entities/loan/super_director.dart';
import 'package:flutter_note/common/entities/loan/user_status.dart';
import 'package:flutter_note/common/entities/login/login_model.dart';
...
class CommonAPI {
  ...
  static Future<CommonResult> createNote(
