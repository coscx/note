...
import 'package:flutter_note/common/entities/loan/audit.dart';
import 'package:flutter_note/common/entities/loan/loan.dart';
import 'package:flutter_note/pages/my_user/widget/my_user_filter_page.dart';
...
class AuditUserLogic extends GetxController {
  final AuditUserState state = AuditUserState();
  List<AuditDataData> loanData = <AuditDataData>[];
  ...
  void _loadData() async {
    curPage = 1;
    var d = await CommonAPI.getAdministrativeAuditList(getFilter({}));
  ...
  void onLoading() async {
    ...
    var d = await CommonAPI.getAdministrativeAuditList(
        getFilter({"pageNum": curPage}));
    if (d.data != null && d.data?.data != null) {
  ...
  setSelectItem(AuditDataData data) {
