...
class _GestureTransformableState extends State<GestureTransformable> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onTapDown: widget.onTapDown == null ? null : (TapDownDetails details) {
        if(widget.onTapDown!=null) widget.onTapDown!(TapDownDetails(
      ...
      onTapUp: widget.onTapUp == null ? null : (TapUpDetails details) {
        if(widget.onTapUp!=null) widget.onTapUp!(TapUpDetails(
          globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform), kind: PointerDeviceKind.mouse,
        ));
      },
      onTap: widget.onTap,
      ...
      onVerticalDragDown: widget.onVerticalDragDown == null ? null : (DragDownDetails details) {
        if(widget.onTapDown!=null) widget.onVerticalDragDown!(DragDownDetails(
          globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform),
        ));
      },
      onVerticalDragStart: widget.onVerticalDragStart == null ? null : (DragStartDetails details) {
        if(widget.onTapDown!=null) widget.onVerticalDragStart!(DragStartDetails(
          globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform),
        ));
      },
      onVerticalDragUpdate: widget.onVerticalDragUpdate == null ? null : (DragUpdateDetails details) {
        if(widget.onTapDown!=null) widget.onVerticalDragUpdate!(DragUpdateDetails(
          globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform),
        ));
      },
      ...
      onHorizontalDragDown: widget.onHorizontalDragDown == null ? null : (DragDownDetails details) {
        if(widget.onTapDown!=null) widget.onHorizontalDragDown!(DragDownDetails(
          globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform),
        ));
      },
      onHorizontalDragStart: widget.onHorizontalDragStart == null ? null : (DragStartDetails details) {
        if(widget.onTapDown!=null) widget.onHorizontalDragStart!(DragStartDetails(
          globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform),
        ));
      },
      onHorizontalDragUpdate: widget.onHorizontalDragUpdate == null ? null : (DragUpdateDetails details) {
        if(widget.onTapDown!=null) widget.onHorizontalDragUpdate!(DragUpdateDetails(
          globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform),
        ));
      },
      ...
      onPanDown: widget.onPanDown == null ? null : (DragDownDetails details) {
        if(widget.onTapDown!=null) widget.onPanDown!(DragDownDetails(
          globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform),
        ));
      },
      onPanStart: widget.onPanStart == null ? null : (DragStartDetails details) {
        if(widget.onTapDown!=null) widget.onPanStart!(DragStartDetails(
          globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform),
        ));
      },
      onPanUpdate: widget.onPanUpdate == null ? null : (DragUpdateDetails details) {
        if(widget.onTapDown!=null)  widget.onPanUpdate!(DragUpdateDetails(
          globalPosition: fromViewport(details.globalPosition - getOffset(context), _transform),
        ));
      },
  ...
  void _onScaleStart(ScaleStartDetails details) {
    if (widget.onScaleStart != null) {
      if(widget.onTapDown!=null)  widget.onScaleStart!(details);
    }
  ...
  void _onScaleUpdate(ScaleUpdateDetails details) {
    ...
    if (widget.onScaleUpdate != null) {
      if(widget.onTapDown!=null)  widget.onScaleUpdate!(ScaleUpdateDetails(
  ...
  void _onScaleEnd(ScaleEndDetails details) {
    if (widget.onScaleEnd != null) {
      if(widget.onTapDown!=null) widget.onScaleEnd!(details);
    }
    setState(() {
      _scaleStart = null;
      _rotationStart = null;
  ...
  void _onAnimateReset() {
    ...
    if (!_controllerReset!.isAnimating) {
      ...
      if(widget.onTapDown!=null) widget.onResetEnd!();
    }
  }
